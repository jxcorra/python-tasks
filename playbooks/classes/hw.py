...
# загруженные данные о персонажах должны быть сохранены в файл
# при следующем запуске программы должна быть проверка: если файл с информацией о персонажах существует, то запрос к api делать нет необходимости и данные могут быть загружены в память из файла
# при работе программы персонажи должны быть представлены объектами класса Character с необходимым набором аттрибутов
# реализуйте класс Aggregator, который аттрибутом принимает список объектов персонажей и, на основании списка всех персонажей, может вывести на экран саггрегированную информацию:
